$(document).ready(function() {
	...
	$("#submit").click(function() {
		...
		var match_first_page = "https://api.steampowered.com/IDOTA2Match_570/GetMatchHistory/V001/?key=xxxxxxxxxxxxxxxxxxxxxxxxxxxx&account_id=" + dota_account;
		...
		$.getJSON("http://query.yahooapis.com/v1/public/yql",
		{
	  	...
	  	function(data) {
            ...
            var match_second_page = "https://api.steampowered.com/IDOTA2Match_570/GetMatchHistory/V001/?key=xxxxxxxxxxxxxxxxxxxxxxxxxxxx&account_id=" + dota_account + "&start_at_match_id=" + last_match_id;
